...
class PetServiceBase(abc.ABC):
    ...
    async def GetPet(
        self,
        stream: "grpclib.server.Stream[petstore.proto.services.pet_service_pb2.GetPetRequest, petstore.proto.petstore_pb2.Pet]",
    ) -> None:
        pass
    ...
    async def ListPets(
        self,
        stream: "grpclib.server.Stream[petstore.proto.services.pet_service_pb2.ListPetRequest, petstore.proto.services.pet_service_pb2.PetList]",
    ) -> None:
        pass
    ...
    async def CreatePet(
        self,
        stream: "grpclib.server.Stream[petstore.proto.petstore_pb2.Pet, petstore.proto.petstore_pb2.Pet]",
    ) -> None:
        pass
